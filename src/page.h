                ...
                bool tx_prove = false)
{
    ...
    {
        return string("Toklio address not provided!");
    }
             ...
             bool tx_prove = false)
{
    ...
    {
        j_response["status"]  = "error";
        j_response["message"] = "Toklio address not provided";
        return j_response;
    }
    ...
    // parse string representing given toklio address
    address_parse_info address_info;

    if (!xmreg::parse_str_address(address_str,  address_info, nettype))
    {
        j_response["status"]  = "error";
        j_response["message"] = "Cant parse toklio address: " + address_str;
        return j_response;
...
json_networkinfo()
{
    ...
    {
        j_response["status"]  = "error";
        j_response["message"] = "Cant get toklio network info";
        return j_response;
    }
